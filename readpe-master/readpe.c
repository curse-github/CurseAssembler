...
main(int argc, char* argv[])
{
	...
	if (pe->sizeOfOptionalHeader > 0) {
		...
		// ...
		printf("  \n");
		printf("  win32VersionValue: %X\n", peOpt->win32VersionValue);
		printf("  sizeOfImage: %X\n", peOpt->sizeOfImage);
		printf("  sizeOfHeaders: %X\n", peOpt->sizeOfHeaders);
		printf("  checksum: %X\n", peOpt->checksum);
		printf("  subsystem: %X\n", peOpt->subsystem);
		printf("  dllCharacteristics: %X\n", peOpt->dllCharacteristics);
		printf("  sizeOfStackReserve: %X\n", peOpt->sizeOfStackReserve);
		printf("  sizeOfStackCommit: %X\n", peOpt->sizeOfStackCommit);
		printf("  sizeOfHeapReserve: %X\n", peOpt->sizeOfHeapReserve);
		printf("  sizeOfHeapCommit: %X\n", peOpt->sizeOfHeapCommit);
