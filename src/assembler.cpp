...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(argv[1],"Linux")==0) {
        ...
        */
        ...
        TEST(textSec,"eax","0x012c");
        TEST(textSec,"ecx","0x012c");
        TEST(textSec,"rax","0x012c");
        TEST(textSec,"rcx","0x012c");
        TEST(textSec,"[eax]","0x012c");
        TEST(textSec,"[ecx]","0x012c");
        TEST(textSec,"[rax]","0x012c");
        TEST(textSec,"[rcx]","0x012c");
        TEST(textSec,"[0x012c]","0x012c");
        TEST(textSec,"[eax+0x012c]","0x012c");
        TEST(textSec,"[ecx+0x012c]","0x012c");
        TEST(textSec,"[rax+0x012c]","0x012c");
        TEST(textSec,"[rcx+0x012c]","0x012c");
        TEST(textSec,"[eax*4+0x012c]","0x012c");
        TEST(textSec,"[ecx*4+0x012c]","0x012c");
        TEST(textSec,"[rax*4+0x012c]","0x012c");
        TEST(textSec,"[rcx*4+0x012c]","0x012c");
        TEST(textSec,"[eax+ecx*4]","0x012c");
        TEST(textSec,"[ecx+eax*4]","0x012c");
        TEST(textSec,"[rax+rcx*4]","0x012c");
        TEST(textSec,"[rcx+rax*4]","0x012c");
        TEST(textSec,"[eax+ecx*4+0x012c]","0x012c");
        TEST(textSec,"[ecx+eax*4+0x012c]","0x012c");
        TEST(textSec,"[rax+rcx*4+0x012c]","0x012c");
        TEST(textSec,"[rcx+rax*4+0x012c]","0x012c");
        ...
        UMUL(textSec, "[rcx]");
        UMUL(textSec, "[0x012c]");
        UMUL(textSec, "[eax+0x012c]");
        UMUL(textSec, "[ecx+0x012c]");
        UMUL(textSec, "[rax+0x012c]");
        UMUL(textSec, "[rcx+0x012c]");
        UMUL(textSec, "[eax*4+0x012c]");
        UMUL(textSec, "[ecx*4+0x012c]");
        UMUL(textSec, "[rax*4+0x012c]");
        UMUL(textSec, "[rcx*4+0x012c]");
        UMUL(textSec, "[eax+ecx*4]");
        UMUL(textSec, "[ecx+eax*4]");
        UMUL(textSec, "[rax+rcx*4]");
        UMUL(textSec, "[rcx+rax*4]");
        UMUL(textSec, "[eax+ecx*4+0x012c]");
        UMUL(textSec, "[ecx+eax*4+0x012c]");
        UMUL(textSec, "[rax+rcx*4+0x012c]");
        UMUL(textSec, "[rcx+rax*4+0x012c]");
        MUL(textSec, "eax");
        MUL(textSec, "ecx");
        MUL(textSec, "rax");
        MUL(textSec, "rcx");
        ...
        MUL(textSec, "[rcx]");
        MUL(textSec, "[0x012c]");
        MUL(textSec, "[eax+0x012c]");
        MUL(textSec, "[ecx+0x012c]");
        MUL(textSec, "[rax+0x012c]");
        MUL(textSec, "[rcx+0x012c]");
        MUL(textSec, "[eax*4+0x012c]");
        MUL(textSec, "[ecx*4+0x012c]");
        MUL(textSec, "[rax*4+0x012c]");
        MUL(textSec, "[rcx*4+0x012c]");
        MUL(textSec, "[eax+ecx*4]");
        MUL(textSec, "[ecx+eax*4]");
        MUL(textSec, "[rax+rcx*4]");
        MUL(textSec, "[rcx+rax*4]");
        MUL(textSec, "[eax+ecx*4+0x012c]");
        MUL(textSec, "[ecx+eax*4+0x012c]");
        MUL(textSec, "[rax+rcx*4+0x012c]");
        MUL(textSec, "[rcx+rax*4+0x012c]");
        UDIV(textSec, "eax");
        UDIV(textSec, "ecx");
        UDIV(textSec, "rax");
        UDIV(textSec, "rcx");
        ...
        UDIV(textSec, "[rcx]");
        UDIV(textSec, "[0x012c]");
        UDIV(textSec, "[eax+0x012c]");
        UDIV(textSec, "[ecx+0x012c]");
        UDIV(textSec, "[rax+0x012c]");
        UDIV(textSec, "[rcx+0x012c]");
        UDIV(textSec, "[eax*4+0x012c]");
        UDIV(textSec, "[ecx*4+0x012c]");
        UDIV(textSec, "[rax*4+0x012c]");
        UDIV(textSec, "[rcx*4+0x012c]");
        UDIV(textSec, "[eax+ecx*4]");
        UDIV(textSec, "[ecx+eax*4]");
        UDIV(textSec, "[rax+rcx*4]");
        UDIV(textSec, "[rcx+rax*4]");
        UDIV(textSec, "[eax+ecx*4+0x012c]");
        UDIV(textSec, "[ecx+eax*4+0x012c]");
        UDIV(textSec, "[rax+rcx*4+0x012c]");
        UDIV(textSec, "[rcx+rax*4+0x012c]");
        DIV(textSec, "eax");
        DIV(textSec, "ecx");
        DIV(textSec, "rax");
        DIV(textSec, "rcx");
        ...
        DIV(textSec, "[rcx]");
        DIV(textSec, "[0x012c]");
        DIV(textSec, "[eax+0x012c]");
        DIV(textSec, "[ecx+0x012c]");
        DIV(textSec, "[rax+0x012c]");
        DIV(textSec, "[rcx+0x012c]");
        DIV(textSec, "[eax*4+0x012c]");
        DIV(textSec, "[ecx*4+0x012c]");
        DIV(textSec, "[rax*4+0x012c]");
        DIV(textSec, "[rcx*4+0x012c]");
        DIV(textSec, "[eax+ecx*4]");
        DIV(textSec, "[ecx+eax*4]");
        DIV(textSec, "[rax+rcx*4]");
        DIV(textSec, "[rcx+rax*4]");
        DIV(textSec, "[eax+ecx*4+0x012c]");
        DIV(textSec, "[ecx+eax*4+0x012c]");
        DIV(textSec, "[rax+rcx*4+0x012c]");
        DIV(textSec, "[rcx+rax*4+0x012c]");
        */
