...
//PeSectionHandler *
template void ADDb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ADDb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void ADDv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ADDv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void ORb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ORb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void ORv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ORv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void ADCb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ADCb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void ADCv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ADCv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void SBBb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void SBBb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void SBBv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void SBBv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void ANDb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ANDb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void ANDv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void ANDv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void SUBb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void SUBb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void SUBv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void SUBv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void XORb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void XORb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void XORv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void XORv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void CMPb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void CMPb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void CMPv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void CMPv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void INCb(PeSectionHandler *&receiver, const char *reg);
template void INCv(PeSectionHandler *&receiver, const char *reg);
template void DECb(PeSectionHandler *&receiver, const char *reg);
template void DECv(PeSectionHandler *&receiver, const char *reg);
template void CALL(PeSectionHandler *&receiver, const uint32_t &value);
template void CALL(PeSectionHandler *&receiver, const char *reg);
template void JMPv(PeSectionHandler *&receiver, const uint32_t &value);
template void JMPv(PeSectionHandler *&receiver, const char *reg);
template void JMPb(PeSectionHandler *&receiver, const uint8_t &value);
template void PUSHb(PeSectionHandler *&receiver, const uint8_t &value);
template void PUSHv(PeSectionHandler *&receiver, const uint32_t &value);
template void PUSHv(PeSectionHandler *&receiver, const char *reg);
template void POP(PeSectionHandler *&receiver, const char *reg);
template void JOV(PeSectionHandler *&receiver, const uint8_t &value);
template void JNOV(PeSectionHandler *&receiver, const uint8_t &value);
template void JULT(PeSectionHandler *&receiver, const uint8_t &value);
template void JUGE(PeSectionHandler *&receiver, const uint8_t &value);
template void JET(PeSectionHandler *&receiver, const uint8_t &value);
template void JNE(PeSectionHandler *&receiver, const uint8_t &value);
template void JULE(PeSectionHandler *&receiver, const uint8_t &value);
template void JUGT(PeSectionHandler *&receiver, const uint8_t &value);
template void JS(PeSectionHandler *&receiver, const uint8_t &value);
template void JNS(PeSectionHandler *&receiver, const uint8_t &value);
template void JP(PeSectionHandler *&receiver, const uint8_t &value);
template void JNP(PeSectionHandler *&receiver, const uint8_t &value);
template void JLT(PeSectionHandler *&receiver, const uint8_t &value);
template void JGE(PeSectionHandler *&receiver, const uint8_t &value);
template void JLE(PeSectionHandler *&receiver, const uint8_t &value);
template void JGT(PeSectionHandler *&receiver, const uint8_t &value);
template void JCXZ(PeSectionHandler *&receiver, const uint8_t &value);
template void NOP(PeSectionHandler *&receiver);
template void XCHGb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void XCHGv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void MOVb(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void MOVv(PeSectionHandler *&receiver, const char *reg1, const char *reg2);
template void MOVb(PeSectionHandler *&receiver, const char *reg, const uint8_t &value);
template void MOVv(PeSectionHandler *&receiver, const char *reg, const uint32_t &value);
template void RETN(PeSectionHandler *&receiver, const uint16_t &value);
template void RETN(PeSectionHandler *&receiver);
template void RETF(PeSectionHandler *&receiver, const uint16_t &value);
template void RETF(PeSectionHandler *&receiver);
template void INT(PeSectionHandler *&receiver);
template void INT(PeSectionHandler *&receiver, const uint8_t &value);
template void LOOPNE(PeSectionHandler *&receiver, const uint8_t &value);
template void LOOPET(PeSectionHandler *&receiver, const uint8_t &value);
template void LOOP(PeSectionHandler *&receiver, const uint8_t &value);
template void HLT(PeSectionHandler *&receiver);
template void TESTb(PeSectionHandler *&receiver, const char *reg1, const uint8_t &value);
template void TESTv(PeSectionHandler *&receiver, const char *reg1, const uint32_t &value);
template void NOTb(PeSectionHandler *&receiver, const char *reg);
template void NOTv(PeSectionHandler *&receiver, const char *reg);
template void NEGb(PeSectionHandler *&receiver, const char *reg);
template void NEGv(PeSectionHandler *&receiver, const char *reg);
template void CLC(PeSectionHandler *&receiver);
template void STC(PeSectionHandler *&receiver);
template void CLI(PeSectionHandler *&receiver);
template void STI(PeSectionHandler *&receiver);
template void CLD(PeSectionHandler *&receiver);
template void STD(PeSectionHandler *&receiver);
